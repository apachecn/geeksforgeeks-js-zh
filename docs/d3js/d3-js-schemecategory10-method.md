# D3 . js scheme category y10 方法

> 原文:[https://www . geesforgeks . org/D3-js-scheme category y10-method/](https://www.geeksforgeeks.org/d3-js-schemecategory10-method/)

**D3.js** 中的**D3 . scheme category y10**方法用于返回十种分类颜色的数组，该数组以 RGB 十六进制字符串的形式返回。
...
下面的例子说明了 D3.js 中的**scheme category y10**方法:
...
    <h3>D3.js schemeCategory10 Method</h3>

    <script> 
        document.write(d3.schemeCategory10[0]+"<br>"); 
        document.write(d3.schemeCategory10[1]+"<br>");
        document.write(d3.schemeCategory10[2]+"<br>");
        document.write(d3.schemeCategory10[3]+"<br>");
        document.write(d3.schemeCategory10[4]+"<br>");
        document.write(d3.schemeCategory10[5]+"<br>");
        document.write(d3.schemeCategory10[6]+"<br>");
        document.write(d3.schemeCategory10[7]+"<br>");
        document.write(d3.schemeCategory10[8]+"<br>");
        document.write(d3.schemeCategory10[9]+"<br>");
    </script> 
    </center>
</body> 
</html>
...
![](img/bd5767cf3fda0b029a58dfa0834dc5a5.png)
...
![](img/d862a48c8e101d9c47ecfe75fbeb3b0b.png)